...
# Iterate through each product and add the "priceInt" property
for product in products:
    # Parse the "price" string to remove commas and convert it to an integer
    price_str = product["price"].replace(",", "")
    price_int = int(price_str)
    # Add the "priceInt" property to the product
    product["priceInt"] = price_int
