<template>
    <form ref="referenceRef" role="search" class="relative" @submit.prevent="submit">
      <SfInput
        ...
        v-model="inputModel"
        aria-label="Search"
        placeholder="Search 'BenQ' or 'EPSON'..."
        @focus="open"
        @keydown="handleInputKeyDown"
        class="lg:w-[500px]  md:w-[300px] h-10 pr-0 rounded-md "
      >
  ...
  const mockProducts: Product[] = [
    { id: 'eg-o9-pro', name: 'EGATE O9 Pro ' },
    { id: 'ep-eb-3lcd', name: 'EPSON EB-E01 XGA 3LCD Projector' },
    ...
    { id: 'benq-EH600', name: 'BenQ EH600 4K' },
